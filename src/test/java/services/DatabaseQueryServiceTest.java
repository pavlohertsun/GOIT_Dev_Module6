...
class DatabaseQueryServiceTest {
    ...
    void findYoungestEldestWorkers() {
        List<Worker> expectedList = List.of(new Worker("youngest Helena 2004-09-03"), new Worker("oldest Mia 1991-03-08"));
        List<Worker> actualList = new DatabaseQueryService().findYoungestEldestWorkers("sql/find_youngest_eldest_workers.sql");
